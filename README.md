...
>
> **Тестирование:** Разработка и отладка велась локально в режиме **Хакатон LLM-only** (бесплатные/дешёвые модели через OpenRouter/LM Studio). **Финальный прогон сабмишн** выполнялся на платной модели (DeepSeek V4 Flash) для скорости.
